...
export function SegmentedControl<T extends string>({
    ...
    return (
        ...
        >
            {/* Sliding Indicator */}
            <div
                className="absolute top-1 bottom-1 bg-[var(--accent-color)] rounded-[calc(var(--radius-2xl)-4px)] shadow-[0_2px_8px_rgba(var(--accent-color-rgb),0.3)] transition-all duration-300 cubic-bezier(0.2, 0.8, 0.2, 1)"
                style={{
